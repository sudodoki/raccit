...
const OPERATIONS = [
  {
    name: 'DELETION',
    isApplicable(x, y, _word1, _word2) { return x >= 0 && y >= 0; },
    score(_x, _y, _word1, _word2) { return -1; },
    shiftX(x) { return x - 1; },
    shiftY(y) { return y; },
  },
  {
  ...
  },
  {
    ...
    score(x, y, word1, _word2) { return 0.5; },
    shiftX(x) { return x - 2; },
    shiftY(y) { return y - 2; },
  },
  {
    name: 'CHANGE',
    isApplicable(x, y, word1, _word2) { return x >= 0 && y >= 0; },
    score(x, y, word1, _word2) { return -1; },
    shiftX(x) { return x - 1; },
    shiftY(y) { return y - 1; },
  },
  {
